...
#       groups=POM_med$Month, ylim = c(1300,-30), auto.key = T)
col_months<-c("#c15063","#5fb14d","#7362cd","#b6b342","#b966bf",
              "#d38c30","#688ccd","#cd4e34","#4bb092","#ce5b95","#737e38","#c07f56")
...
plot(POM_med$Longitude, POM_med$Latitude, pch=19, col='grey', xlab='',ylab='',
     cex=2.1, xlim=c(-5,26), ylim=c(30,45))
par(new=T)
plot(Alb$Longitude, Alb$Latitude,pch=19, col='#9e014266', xlab='',ylab='',cex=1.3,
     xlim=c(-5,26), ylim=c(30,45))
par(new=T)
plot(Sww$Longitude, Sww$Latitude,pch=19, col='#d53e4f66', xlab='',ylab='',cex=1.3,
     xlim=c(-5,26), ylim=c(30,45))
par(new=T)
plot(Swe$Longitude, Swe$Latitude,pch=19, col='#f46d4366', xlab='',ylab='',cex=1.3,
     xlim=c(-5,26), ylim=c(30,45))
par(new=T)
plot(Nwm$Longitude, Nwm$Latitude,pch=19, col='#fdae6166', xlab='',ylab='',cex=1.3,
     xlim=c(-5,26), ylim=c(30,45))
par(new=T)
plot(Tir$Longitude, Tir$Latitude,pch=19, col='#fee08b66',xlab='',ylab='',cex=1.3,
     xlim=c(-5,26), ylim=c(30,45))
par(new=T)
plot(Ion$Longitude, Ion$Latitude,pch=19, col='#e6f59866', xlab='',ylab='',cex=1.3,
     xlim=c(-5,26), ylim=c(30,45))
par(new=T)
plot(Sad$Longitude, Sad$Latitude,pch=19, col='#abdda466', xlab='',ylab='',cex=1.3,
     xlim=c(-5,26), ylim=c(30,45))
par(new=T)
plot(Nad$Longitude, Nad$Latitude,pch=19, col='#66c2a566', xlab='',ylab='',cex=1.3,
     xlim=c(-5,26), ylim=c(30,45))
par(new=T)
plot(Lev$Longitude, Lev$Latitude,pch=19, col='#3288bd66', xlab='',ylab='',cex=1.3,
     xlim=c(-5,26), ylim=c(30,45))
par(new=T)
plot(Aeg$Longitude, Aeg$Latitude,pch=19, col='#5e4fa266', xlab='Longitude',ylab='Latitude',
     xlim=c(-5,26), ylim=c(30,45))
