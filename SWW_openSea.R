...
png('POC_Sww.png',width = 28, height = 19, units = "cm", res = 300)
par(mfrow=c(1,1))
plot(Sww$POC_ugL[1:10], Sww$Depth[1:10], xlim=c(0,100), ylim=c(200,0), col=col_months[9], 
     bg='#B385FF44',type='b', 
